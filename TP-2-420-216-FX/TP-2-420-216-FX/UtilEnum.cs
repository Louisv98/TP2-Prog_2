...
namespace TP_2_420_216_FX
{
    ...
    public static class UtilEnum
    {
            ...
            /// </summary>
            /// <param name="currentEnum">Énumération pour laquelle on ajoute la méthode GetDescription.</param>
            /// <returns>
            ...
            /// </summary>
            /// <returns>
            /// Les descriptions associées aux constantes de l'énumération ou bien les valeurs s'il n'y a pas de description.
            /// </returns>
